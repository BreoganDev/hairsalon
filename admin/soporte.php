...
?>
    ...
    <div class="container"><!--Comienza Container-->
        ...
        <div class="card-body">
            ...
            <p class="card-text">A la atención: Diego Fernández</p>
            <p class="card-text">Correo Electrónico: intydeveloper@gmail.com</p>
            <p class="card-text">WhatsApp: +34 617532360</p>
