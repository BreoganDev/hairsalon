...
<body>
   <?php include "header.php"; ?>
    ...
    <a href="/test/admin/panel_grissel.php" class="btn btn-modern">Disponibilidad</a>
    <a href="/test/admin/lista_clientas.php" class="btn btn-modern">Clientas</a> <!-- Nuevo botón "Clientas" -->
    ...
    <div class="row"><div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="/test/admin/mod_reservas.php" class="btn btn-primary"><i class="fas fa-calendar"></i> Ir a detalles</a>
                    </div>
                </div>
            </div>
